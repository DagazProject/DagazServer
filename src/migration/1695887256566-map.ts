...
export class map1695887256566 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1923, 19, 'Alice Chess', 'alice-chess', 'chess-1', 'https://en.wikipedia.org/wiki/Alice_Chess', '1953 V.R. Parton')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules) values(1924, 19, 'Andernach Chess', 'andernach-chess', 'chess-1', 'https://en.wikipedia.org/wiki/Andernach_chess')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1925, 19, 'Benedict Chess', 'benedict-chess', 'chess-1', 'https://www.chessvariants.com/difftaking.dir/benedict.html', '2001 W. D. Troyka')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview) values(1926, 19, 'Genesis Chess', 'genesis-chess', 'genesis-chess-1')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1927, 19, 'Fighting Chess', 'fighting-chess', 'chess-1', 'https://newboardgamesabovechess.blogspot.com/2020/11/fighting-chess-rules.html', '2018 Tony Berard')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, copyright) values(1928, 19, 'Vis-a-vis Chess', 'visavis-chess', 'chess-1', '2014 Viktor Pankovich')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, copyright) values(1929, 19, 'King''s Vis-a-vis Chess', 'visavis-free', 'visavis-chess', '2014 Viktor Pankovich')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview) values(1930, 19, 'Resurrection Chess', 'resurrection-chess', 'chess-1')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview) values(1931, 19, 'Momentum Chess', 'momentum-chess', 'chess-1')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1932, 19, 'Madrasi Chess', 'madrasi-chess', 'chess-1', 'https://en.wikipedia.org/wiki/Madrasi_chess', '1979 Abdul Jabbar Karwatkar')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1933, 19, 'Patrol Chess', 'patrol-chess', 'chess-1', 'https://en.wikipedia.org/wiki/Patrol_chess', '1975 Frederik Hendrik von Meyenfeldt')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1934, 19, 'Neutral King Chess', 'neutral-king', 'neutral-king', 'https://www.chessvariants.com/winning.dir/neutral-king.html', '1953 V.R. Parton')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1935, 19, 'Anti King Chess', 'anti-king', 'anti-king', 'https://www.chessvariants.com/diffobjective.dir/anti-king-chess.html', 'Peter Aronson')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1936, 19, 'Balbo''s Game', 'balbo-chess', 'balbo', 'https://en.wikipedia.org/wiki/Balbo%27s_Game', '1974 M. [Monsieur] G. Balbo')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1937, 19, 'Troitzky Chess', 'troitzky-chess', 'troitzky-1', 'http://mlwi.magix.net/bg/troitzkychess.htm', 'Paul Byway')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1938, 19, 'Battle of the Kings', 'botk', 'botk', 'https://www.chessvariants.com/rules/battle-of-kings-', '2021 Vadrya Pokshtya')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, copyright) values(1939, 19, 'Platform Chess', 'platform-chess', 'platform-chess-1', '2001 Robert Price')`);
