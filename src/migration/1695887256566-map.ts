...
export class map1695887256566 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1922, 19, 'Alice Chess', 'alice-chess', 'chess-1', 'https://en.wikipedia.org/wiki/Alice_Chess', '1953 V.R. Parton')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules) values(1923, 19, 'Andernach Chess', 'andernach-chess', 'chess-1', 'https://en.wikipedia.org/wiki/Andernach_chess')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1924, 19, 'Benedict Chess', 'benedict-chess', 'chess-1', 'https://www.chessvariants.com/difftaking.dir/benedict.html', '2001 W. D. Troyka')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview) values(1925, 19, 'Genesis Chess', 'genesis-chess', 'genesis-chess-1')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1926, 19, 'Fighting Chess', 'fighting-chess', 'chess-1', 'https://newboardgamesabovechess.blogspot.com/2020/11/fighting-chess-rules.html', '2018 Tony Berard')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, copyright) values(1927, 19, 'Vis-a-vis Chess', 'visavis-chess', 'chess-1', '2014 Viktor Pankovich')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, copyright) values(1928, 19, 'King''s Vis-a-vis Chess', 'visavis-free', 'visavis-chess', '2014 Viktor Pankovich')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview) values(1929, 19, 'Resurrection Chess', 'resurrection-chess', 'chess-1')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview) values(1930, 19, 'Momentum Chess', 'momentum-chess', 'chess-1')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1931, 19, 'Madrasi Chess', 'madrasi-chess', 'chess-1', 'https://en.wikipedia.org/wiki/Madrasi_chess', '1979 Abdul Jabbar Karwatkar')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1932, 19, 'Patrol Chess', 'patrol-chess', 'chess-1', 'https://en.wikipedia.org/wiki/Patrol_chess', '1975 Frederik Hendrik von Meyenfeldt')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1933, 19, 'Neutral King Chess', 'neutral-king', 'neutral-king', 'https://www.chessvariants.com/winning.dir/neutral-king.html', '1953 V.R. Parton')`);
        ...
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules) values(7716, 77, 'Annan Shogi', 'annan-shogi', 'annan-shogi', 'https://en.wikipedia.org/wiki/Annan_shogi')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(7717, 77, 'Micro Shogi', 'micro-shogi', 'micro-shogi', 'https://en.wikipedia.org/wiki/Micro_shogi', '1982 Oyama Yasuharu')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(7718, 77, 'Kyoto Shogi', 'kyoto-shogi', 'kyoto-shogi', 'https://en.wikipedia.org/wiki/Kyoto_shogi', '1976 Tamiya Katsuya')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, copyright) values(7719, 77, 'Hexagonal Kyoto Shogi', 'hex-kyoto-shogi', 'hex-kyoto-shogi', '2000 Jochen Drechsler')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules) values(7720, 77, 'Chu Shogi', 'chu-shogi', 'chu-shogi', 'https://en.wikipedia.org/wiki/Chu_shogi')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules) values(7721, 77, 'Tenjiku Shogi', 'tenjiku-shogi', 'tenjiku-shogi', 'https://en.wikipedia.org/wiki/Tenjiku_shogi')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules) values(7722, 77, 'Wa Shogi', 'wa-shogi', 'wa-shogi', 'https://www.chessvariants.com/rules/wa-shogi')`);
