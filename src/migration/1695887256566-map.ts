...
export class map1695887256566 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, copyright) values(8003, 80, 'Epsilon 64', 'epsilon-64', 'epsilon-64', 'Viktor Kupchenko')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, copyright) values(8004, 80, 'ZERTZ', 'zertz', 'zertz', '1999 Kris Burm')`);
...
//      await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, copyright) values(206, 2, 'Stavropol Adiyukh Checkers (10x10)', 'stavropol-adiuh-checkers-10x10', 'adiuh-checkers-10x10', '2007 Viktor Pankovich')`);
//      await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, copyright) values(207, 2, 'King''s Adiyukh Checkers', 'king-adiuh-checkers-10x10', 'king-adiuh-checkers-10x10', '2007 Viktor Pankovich')`);
        ...
        await queryRunner.query(`insert into game_map(id, parent_id, name, preview, rules, copyright) values(1962, 19, 'Klin Zha', 'klin-zha', 'http://www.tasigh.org/takzh/open.html', '1989 Leonard B. Loyd, Jr')`);

        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1963, 1962, 'Klin Zha', 'klin-zha', 'klin-zha-3d', 'http://www.tasigh.org/takzh/open.html', '1989 Leonard B. Loyd, Jr')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1964, 1962, '3D Klin Zha', '3d-klin-zha', '3d-klin-zha', 'http://www.tasigh.org/takzh/open.html', '1989 Leonard B. Loyd, Jr')`);
        ...
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1903, 1947, 'Micro Chess', 'micro-chess', 'micro-chess-1', 'https://en.wikipedia.org/wiki/Minichess', '1997 Glimne')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules) values(1904, 1947, 'Mini Chess', 'mini-chess', 'mini-chess-1', 'https://en.wikipedia.org/wiki/Minichess')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1905, 1947, 'Gardner''s Chess', 'gardner-chess', 'gardner-1', 'https://en.wikipedia.org/wiki/Minichess', '1969 Martin Gardner')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1906, 1947, 'Los Alamos Chess', 'los-alamos-chess', 'los-alamos', 'https://en.wikipedia.org/wiki/Los_Alamos_chess', '1956 Paul Stein, Mark Wells')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1907, 1947, 'Demi Chess', 'demi-chess', 'demi-chess', 'https://en.wikipedia.org/wiki/Minichess', '1986 Peter Krystufek')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules) values(1908, 1947, 'Courier Chess', 'courier-chess', 'courier-chess-1', 'https://en.wikipedia.org/wiki/Courier_chess')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules) values(1909, 1947, 'Short Assize', 'short-assize', 'short-assize', 'https://en.wikipedia.org/wiki/Short_assize')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview) values(1910, 1947, 'Maharadja', 'maharadja', 'maharadja-1')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules) values(1911, 1947, 'Chess', 'chess', 'chess-1', 'https://en.wikipedia.org/wiki/Chess')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules) values(1912, 1947, 'Dark Chess', 'dark-chess', 'dark-chess', 'https://en.wikipedia.org/wiki/Chess')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, copyright) values(1913, 1947, 'Romantic Chess', 'romantic-chess', 'chess-1', 'Michal Ryszard Wojcik')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1914, 1947, 'Chess960', 'fisher-chess', 'fisher-chess', 'https://en.wikipedia.org/wiki/Fischer_random_chess', '1996 Bobby Fischer')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules) values(1915, 1947, 'Bomb Chess', 'bomb-chess', 'bomb-chess-1', 'https://en.wikipedia.org/wiki/Chess')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview) values(1916, 1947, 'Rock Chess', 'rock-chess', 'rock-chess')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1917, 1947, 'Legan Chess', 'legan-chess', 'legan-chess', 'https://en.wikipedia.org/wiki/Legan_chess', '1913 L. Legan')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview) values(1918, 1947, 'Hoppel-Poppel Chess', 'hoppel-poppel', 'hoppel-poppel')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview) values(1919, 1947, 'Belarusian Chess', 'belarusian-chess', 'belarusian-chess-1')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1920, 1947, 'Men Row Chess', 'menrow', 'menrow', 'https://www.iggamecenter.com/info/en/menrowchess.html', '2008 Giuseppe Acciaro')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules) values(1921, 1947, 'Chessgi', 'chessgi', 'chess-1', 'https://www.chessvariants.com/other.dir/chessgi.html')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, preview, rules, copyright) values(1922, 1947, 'Dragonfly', 'dragonfly', 'https://en.wikipedia.org/wiki/Dragonfly_(chess_variant)', '1983 Christian Freeling')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1924, 1947, 'Alice Chess', 'alice-chess', 'chess-1', 'https://en.wikipedia.org/wiki/Alice_Chess', '1953 V.R. Parton')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules) values(1925, 1947, 'Andernach Chess', 'andernach-chess', 'chess-1', 'https://en.wikipedia.org/wiki/Andernach_chess')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1926, 1947, 'Benedict Chess', 'benedict-chess', 'chess-1', 'https://www.chessvariants.com/difftaking.dir/benedict.html', '2001 W. D. Troyka')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview) values(1927, 1947, 'Genesis Chess', 'genesis-chess', 'genesis-chess-1')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1928, 1947, 'Fighting Chess', 'fighting-chess', 'chess-1', 'https://newboardgamesabovechess.blogspot.com/2020/11/fighting-chess-rules.html', '2018 Tony Berard')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, copyright) values(1929, 1947, 'Vis-a-vis Chess', 'visavis-chess', 'chess-1', '2014 Viktor Pankovich')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, copyright) values(1930, 1947, 'King''s Vis-a-vis Chess', 'visavis-free', 'visavis-chess', '2014 Viktor Pankovich')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview) values(1931, 1947, 'Resurrection Chess', 'resurrection-chess', 'chess-1')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview) values(1932, 1947, 'Momentum Chess', 'momentum-chess', 'chess-1')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1933, 1947, 'Madrasi Chess', 'madrasi-chess', 'chess-1', 'https://en.wikipedia.org/wiki/Madrasi_chess', '1979 Abdul Jabbar Karwatkar')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1934, 1947, 'Patrol Chess', 'patrol-chess', 'chess-1', 'https://en.wikipedia.org/wiki/Patrol_chess', '1975 Frederik Hendrik von Meyenfeldt')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1935, 1947, 'Neutral King Chess', 'neutral-king', 'neutral-king', 'https://www.chessvariants.com/winning.dir/neutral-king.html', '1953 V.R. Parton')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1936, 1947, 'Anti King Chess', 'anti-king', 'anti-king', 'https://www.chessvariants.com/diffobjective.dir/anti-king-chess.html', 'Peter Aronson')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1937, 1947, 'Balbo''s Game', 'balbo-chess', 'balbo', 'https://en.wikipedia.org/wiki/Balbo%27s_Game', '1974 M. [Monsieur] G. Balbo')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1938, 1947, 'Troitzky Chess', 'troitzky-chess', 'troitzky-1', 'http://mlwi.magix.net/bg/troitzkychess.htm', 'Paul Byway')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, preview, rules, copyright) values(1939, 1947, 'Battle of the Kings', 'botk', 'https://www.chessvariants.com/rules/battle-of-kings-', '2021 Vadrya Pokshtya')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, copyright) values(1940, 1947, 'Platform Chess', 'platform-chess', 'platform-chess-1', '2001 Robert Price')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, preview, rules, copyright) values(1943, 1947, 'Omega Chess', 'omega', 'https://en.wikipedia.org/wiki/Omega_Chess', '1992 Daniel MacDonald')`);

        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1948, 1939, 'Battle of the Kings', 'botk', 'botk', 'https://www.chessvariants.com/rules/battle-of-kings-', '2021 Vadrya Pokshtya')`);
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(1949, 1939, 'Jabberwocky Chess', 'jabberwocky', 'jabberwocky', 'https://www.chessvariants.com/rules/jabberwocky-chess', '2024 Vadrya Pokshtya')`);
        ...
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(3304, 33, 'Dragon Eyes', 'dragon-eyes', 'dragon-eyes', 'https://granddicechess.livejournal.com/14821.html', '2024 Vadrya Pokshtya')`);
        ...
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, rules, copyright) values(4506, 45, 'Hexes Chess', 'hexes', 'hexes', 'https://hexeschess.com/', '2002 Michael Layfield')`);
