...
export class map1695887256566 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`insert into game_map(id, parent_id, name, filename, preview, copyright) values(206, 2, 'King Adiyukh Checkers (8x8)', 'king-adiuh-checkers', 'king-adiuh-checkers', '2007 Viktor Pankovich')`);
