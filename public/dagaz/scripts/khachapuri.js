...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("White", "Man", 311);
    design.setup("White", "Man", 312);
    design.setup("White", "Man", 313);
    design.setup("White", "Man", 314);
    design.setup("White", "Man", 315);
    design.setup("White", "Man", 316);
    design.setup("White", "Man", 317);
