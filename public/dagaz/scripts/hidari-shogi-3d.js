...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addPosition("D6", [0, 0, 0, -1, 0, 0, 0, 0, 38]);
    design.addPosition("E6", [0, 0, 0, 1, 0, 0, 0, 0, 8]);
    design.addPosition("F6", [0, 0, 0, 0, -1, 0, 0, 0, 0]);
    design.addPosition("G6", [0, 0, 0, 1, 0, 0, 0, 0, 8]);
    design.addPosition("H6", [0, 0, 0, 0, -1, 0, 0, 0, 0]);
    design.addPosition("A5", [0, 0, 0, 0, 1, 0, 0, 0, 0]);
    design.addPosition("B5", [0, 0, 0, -1, 0, 0, 0, 0, -8]);
    design.addPosition("C5", [0, 0, 0, 0, 1, 0, 0, 0, 0]);
    design.addPosition("D5", [0, 0, 0, -1, 0, 0, 0, 0, -8]);
    ...
    design.addPosition("E1", [0, 0, 0, 1, 0, 0, 0, 0, -38]);
    ...
    design.addZone("last-ranks", 2, [25, 26, 27, 28, 29, 20, 21, 22, 23, 24]);
    ...
    design.setup("South", "King", p('E6'));
    design.setup("South", "Rook", p('E5'));
    design.setup("South", "Pawn", p('F5'));
    design.setup("South", "Bishop", p('E4'));
    design.setup("South", "Copper", p('F4'));
    design.setup("South", "Gold", p('E3'));
    design.setup("South", "Knight", p('F3'));
    design.setup("South", "Silver", p('E2'));
    design.setup("South", "Lance", p('F2'));
    design.setup("North", "King", p('D1'));
    design.setup("North", "Rook", p('D2'));
    design.setup("North", "Pawn", p('C2'));
    design.setup("North", "Bishop", p('D3'));
    design.setup("North", "Copper", p('C3'));
    design.setup("North", "Gold", p('D4'));
    design.setup("North", "Knight", p('C4'));
    design.setup("North", "Silver", p('D5'));
    design.setup("North", "Lance", p('C5'));
}
...
Dagaz.View.configure = function(view) {
    ...
    view.defPiecePlatform(4, 3, 100, 100, 1, 0, [0xFFEDCB, 0xAC5146, 0xAC5146, 0xAC5146, 0xAC5146, 0xFFEDCB], "NSKnight");
    view.defPiecePlatform(4, 4, 100, 100, 1, 0, [0xFFEDCB, 0xAC5146, 0xAC5146, 0xAC5146, 0xAC5146, 0xFFEDCB], "NNKnight");
    ...
    view.defPiecePlatform(5, 3, 100, 100, 1, 0, [0xFFEDCB, 0xAC5146, 0xAC5146, 0xAC5146, 0xAC5146, 0xFFEDCB], "NSLance");
    view.defPiecePlatform(5, 4, 100, 100, 1, 0, [0xFFEDCB, 0xAC5146, 0xAC5146, 0xAC5146, 0xAC5146, 0xFFEDCB], "NNLance");
