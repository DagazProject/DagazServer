...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("X11", 783, 497, 48, 48);
    view.defPosition("Y11", 735, 497, 48, 48);
    view.defPosition("M11", 687, 497, 48, 48);
    view.defPosition("a11", 639, 497, 48, 48);
    view.defPosition("b11", 591, 497, 48, 48);
    view.defPosition("c11", 543, 497, 48, 48);
    view.defPosition("d11", 495, 497, 48, 48);
    view.defPosition("e11", 447, 497, 48, 48);
    view.defPosition("f11", 399, 497, 48, 48);
    view.defPosition("g11", 351, 497, 48, 48);
    view.defPosition("h11", 303, 497, 48, 48);
    view.defPosition("i11", 255, 497, 48, 48);
    view.defPosition("j11", 207, 497, 48, 48);
    view.defPosition("k11", 159, 497, 48, 48);
    view.defPosition("N11", 111, 497, 48, 48);
    view.defPosition("Z11", 63, 497, 48, 48);
    view.defPosition("T11", 15, 497, 48, 48);
    view.defPosition("X10", 783, 449, 48, 48);
    view.defPosition("Y10", 735, 449, 48, 48);
    view.defPosition("M10", 687, 449, 48, 48);
    view.defPosition("a10", 639, 449, 48, 48);
    view.defPosition("b10", 591, 449, 48, 48);
    view.defPosition("c10", 543, 449, 48, 48);
    view.defPosition("d10", 495, 449, 48, 48);
    view.defPosition("e10", 447, 449, 48, 48);
    view.defPosition("f10", 399, 449, 48, 48);
    view.defPosition("g10", 351, 449, 48, 48);
    view.defPosition("h10", 303, 449, 48, 48);
    view.defPosition("i10", 255, 449, 48, 48);
    view.defPosition("j10", 207, 449, 48, 48);
    view.defPosition("k10", 159, 449, 48, 48);
    view.defPosition("N10", 111, 449, 48, 48);
    view.defPosition("Z10", 63, 449, 48, 48);
    view.defPosition("T10", 15, 449, 48, 48);
    view.defPosition("X9", 783, 401, 48, 48);
    view.defPosition("Y9", 735, 401, 48, 48);
    view.defPosition("M9", 687, 401, 48, 48);
    view.defPosition("a9", 639, 401, 48, 48);
    view.defPosition("b9", 591, 401, 48, 48);
    view.defPosition("c9", 543, 401, 48, 48);
    view.defPosition("d9", 495, 401, 48, 48);
    view.defPosition("e9", 447, 401, 48, 48);
    view.defPosition("f9", 399, 401, 48, 48);
    view.defPosition("g9", 351, 401, 48, 48);
    view.defPosition("h9", 303, 401, 48, 48);
    view.defPosition("i9", 255, 401, 48, 48);
    view.defPosition("j9", 207, 401, 48, 48);
    view.defPosition("k9", 159, 401, 48, 48);
    view.defPosition("N9", 111, 401, 48, 48);
    view.defPosition("Z9", 63, 401, 48, 48);
    view.defPosition("T9", 15, 401, 48, 48);
    view.defPosition("X8", 783, 353, 48, 48);
    view.defPosition("Y8", 735, 353, 48, 48);
    view.defPosition("M8", 687, 353, 48, 48);
    view.defPosition("a8", 639, 353, 48, 48);
    view.defPosition("b8", 591, 353, 48, 48);
    view.defPosition("c8", 543, 353, 48, 48);
    view.defPosition("d8", 495, 353, 48, 48);
    view.defPosition("e8", 447, 353, 48, 48);
    view.defPosition("f8", 399, 353, 48, 48);
    view.defPosition("g8", 351, 353, 48, 48);
    view.defPosition("h8", 303, 353, 48, 48);
    view.defPosition("i8", 255, 353, 48, 48);
    view.defPosition("j8", 207, 353, 48, 48);
    view.defPosition("k8", 159, 353, 48, 48);
    view.defPosition("N8", 111, 353, 48, 48);
    view.defPosition("Z8", 63, 353, 48, 48);
    view.defPosition("T8", 15, 353, 48, 48);
    view.defPosition("X7", 783, 305, 48, 48);
    view.defPosition("Y7", 735, 305, 48, 48);
    view.defPosition("M7", 687, 305, 48, 48);
    view.defPosition("a7", 639, 305, 48, 48);
    view.defPosition("b7", 591, 305, 48, 48);
    view.defPosition("c7", 543, 305, 48, 48);
    view.defPosition("d7", 495, 305, 48, 48);
    view.defPosition("e7", 447, 305, 48, 48);
    view.defPosition("f7", 399, 305, 48, 48);
    view.defPosition("g7", 351, 305, 48, 48);
    view.defPosition("h7", 303, 305, 48, 48);
    view.defPosition("i7", 255, 305, 48, 48);
    view.defPosition("j7", 207, 305, 48, 48);
    view.defPosition("k7", 159, 305, 48, 48);
    view.defPosition("N7", 111, 305, 48, 48);
    view.defPosition("Z7", 63, 305, 48, 48);
    view.defPosition("T7", 15, 305, 48, 48);
    view.defPosition("X6", 783, 257, 48, 48);
    view.defPosition("Y6", 735, 257, 48, 48);
    view.defPosition("M6", 687, 257, 48, 48);
    view.defPosition("a6", 639, 257, 48, 48);
    view.defPosition("b6", 591, 257, 48, 48);
    view.defPosition("c6", 543, 257, 48, 48);
    view.defPosition("d6", 495, 257, 48, 48);
    view.defPosition("e6", 447, 257, 48, 48);
    view.defPosition("f6", 399, 257, 48, 48);
    view.defPosition("g6", 351, 257, 48, 48);
    view.defPosition("h6", 303, 257, 48, 48);
    view.defPosition("i6", 255, 257, 48, 48);
    view.defPosition("j6", 207, 257, 48, 48);
    view.defPosition("k6", 159, 257, 48, 48);
    view.defPosition("N6", 111, 257, 48, 48);
    view.defPosition("Z6", 63, 257, 48, 48);
    view.defPosition("T6", 15, 257, 48, 48);
    view.defPosition("X5", 783, 209, 48, 48);
    view.defPosition("Y5", 735, 209, 48, 48);
    view.defPosition("M5", 687, 209, 48, 48);
    view.defPosition("a5", 639, 209, 48, 48);
    view.defPosition("b5", 591, 209, 48, 48);
    view.defPosition("c5", 543, 209, 48, 48);
    view.defPosition("d5", 495, 209, 48, 48);
    view.defPosition("e5", 447, 209, 48, 48);
    view.defPosition("f5", 399, 209, 48, 48);
    view.defPosition("g5", 351, 209, 48, 48);
    view.defPosition("h5", 303, 209, 48, 48);
    view.defPosition("i5", 255, 209, 48, 48);
    view.defPosition("j5", 207, 209, 48, 48);
    view.defPosition("k5", 159, 209, 48, 48);
    view.defPosition("N5", 111, 209, 48, 48);
    view.defPosition("Z5", 63, 209, 48, 48);
    view.defPosition("T5", 15, 209, 48, 48);
    view.defPosition("X4", 783, 161, 48, 48);
    view.defPosition("Y4", 735, 161, 48, 48);
    view.defPosition("M4", 687, 161, 48, 48);
    view.defPosition("a4", 639, 161, 48, 48);
    view.defPosition("b4", 591, 161, 48, 48);
    view.defPosition("c4", 543, 161, 48, 48);
    view.defPosition("d4", 495, 161, 48, 48);
    view.defPosition("e4", 447, 161, 48, 48);
    view.defPosition("f4", 399, 161, 48, 48);
    view.defPosition("g4", 351, 161, 48, 48);
    view.defPosition("h4", 303, 161, 48, 48);
    view.defPosition("i4", 255, 161, 48, 48);
    view.defPosition("j4", 207, 161, 48, 48);
    view.defPosition("k4", 159, 161, 48, 48);
    view.defPosition("N4", 111, 161, 48, 48);
    view.defPosition("Z4", 63, 161, 48, 48);
    view.defPosition("T4", 15, 161, 48, 48);
    view.defPosition("X3", 783, 113, 48, 48);
    view.defPosition("Y3", 735, 113, 48, 48);
    view.defPosition("M3", 687, 113, 48, 48);
    view.defPosition("a3", 639, 113, 48, 48);
    view.defPosition("b3", 591, 113, 48, 48);
    view.defPosition("c3", 543, 113, 48, 48);
    view.defPosition("d3", 495, 113, 48, 48);
    view.defPosition("e3", 447, 113, 48, 48);
    view.defPosition("f3", 399, 113, 48, 48);
    view.defPosition("g3", 351, 113, 48, 48);
    view.defPosition("h3", 303, 113, 48, 48);
    view.defPosition("i3", 255, 113, 48, 48);
    view.defPosition("j3", 207, 113, 48, 48);
    view.defPosition("k3", 159, 113, 48, 48);
    view.defPosition("N3", 111, 113, 48, 48);
    view.defPosition("Z3", 63, 113, 48, 48);
    view.defPosition("T3", 15, 113, 48, 48);
    view.defPosition("X2", 783, 65, 48, 48);
    view.defPosition("Y2", 735, 65, 48, 48);
    view.defPosition("M2", 687, 65, 48, 48);
    view.defPosition("a2", 639, 65, 48, 48);
    view.defPosition("b2", 591, 65, 48, 48);
    view.defPosition("c2", 543, 65, 48, 48);
    view.defPosition("d2", 495, 65, 48, 48);
    view.defPosition("e2", 447, 65, 48, 48);
    view.defPosition("f2", 399, 65, 48, 48);
    view.defPosition("g2", 351, 65, 48, 48);
    view.defPosition("h2", 303, 65, 48, 48);
    view.defPosition("i2", 255, 65, 48, 48);
    view.defPosition("j2", 207, 65, 48, 48);
    view.defPosition("k2", 159, 65, 48, 48);
    view.defPosition("N2", 111, 65, 48, 48);
    view.defPosition("Z2", 63, 65, 48, 48);
    view.defPosition("T2", 15, 65, 48, 48);
    view.defPosition("X1", 783, 17, 48, 48);
    view.defPosition("Y1", 735, 17, 48, 48);
    view.defPosition("M1", 687, 17, 48, 48);
    view.defPosition("a1", 639, 17, 48, 48);
    view.defPosition("b1", 591, 17, 48, 48);
    view.defPosition("c1", 543, 17, 48, 48);
    view.defPosition("d1", 495, 17, 48, 48);
    view.defPosition("e1", 447, 17, 48, 48);
    view.defPosition("f1", 399, 17, 48, 48);
    view.defPosition("g1", 351, 17, 48, 48);
    view.defPosition("h1", 303, 17, 48, 48);
    view.defPosition("i1", 255, 17, 48, 48);
    view.defPosition("j1", 207, 17, 48, 48);
    view.defPosition("k1", 159, 17, 48, 48);
    view.defPosition("N1", 111, 17, 48, 48);
    view.defPosition("Z1", 63, 17, 48, 48);
    view.defPosition("T1", 15, 17, 48, 48);
}
