...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("X11", 783, 494, 48, 48);
    view.defPosition("Y11", 735, 494, 48, 48);
    view.defPosition("M11", 687, 494, 48, 48);
    view.defPosition("a11", 639, 494, 48, 48);
    view.defPosition("b11", 591, 494, 48, 48);
    view.defPosition("c11", 543, 494, 48, 48);
    view.defPosition("d11", 495, 494, 48, 48);
    view.defPosition("e11", 447, 494, 48, 48);
    view.defPosition("f11", 399, 494, 48, 48);
    view.defPosition("g11", 351, 494, 48, 48);
    view.defPosition("h11", 303, 494, 48, 48);
    view.defPosition("i11", 255, 494, 48, 48);
    view.defPosition("j11", 207, 494, 48, 48);
    view.defPosition("k11", 159, 494, 48, 48);
    view.defPosition("N11", 111, 494, 48, 48);
    view.defPosition("Z11", 63, 494, 48, 48);
    view.defPosition("T11", 15, 494, 48, 48);
    view.defPosition("X10", 783, 446, 48, 48);
    view.defPosition("Y10", 735, 446, 48, 48);
    view.defPosition("M10", 687, 446, 48, 48);
    view.defPosition("a10", 639, 446, 48, 48);
    view.defPosition("b10", 591, 446, 48, 48);
    view.defPosition("c10", 543, 446, 48, 48);
    view.defPosition("d10", 495, 446, 48, 48);
    view.defPosition("e10", 447, 446, 48, 48);
    view.defPosition("f10", 399, 446, 48, 48);
    view.defPosition("g10", 351, 446, 48, 48);
    view.defPosition("h10", 303, 446, 48, 48);
    view.defPosition("i10", 255, 446, 48, 48);
    view.defPosition("j10", 207, 446, 48, 48);
    view.defPosition("k10", 159, 446, 48, 48);
    view.defPosition("N10", 111, 446, 48, 48);
    view.defPosition("Z10", 63, 446, 48, 48);
    view.defPosition("T10", 15, 446, 48, 48);
    view.defPosition("X9", 783, 400, 48, 48);
    view.defPosition("Y9", 735, 400, 48, 48);
    view.defPosition("M9", 687, 400, 48, 48);
    view.defPosition("a9", 639, 400, 48, 48);
    view.defPosition("b9", 591, 400, 48, 48);
    view.defPosition("c9", 543, 400, 48, 48);
    view.defPosition("d9", 495, 400, 48, 48);
    view.defPosition("e9", 447, 400, 48, 48);
    view.defPosition("f9", 399, 400, 48, 48);
    view.defPosition("g9", 351, 400, 48, 48);
    view.defPosition("h9", 303, 400, 48, 48);
    view.defPosition("i9", 255, 400, 48, 48);
    view.defPosition("j9", 207, 400, 48, 48);
    view.defPosition("k9", 159, 400, 48, 48);
    view.defPosition("N9", 111, 400, 48, 48);
    view.defPosition("Z9", 63, 400, 48, 48);
    view.defPosition("T9", 15, 400, 48, 48);
    view.defPosition("X8", 783, 352, 48, 48);
    view.defPosition("Y8", 735, 352, 48, 48);
    view.defPosition("M8", 687, 352, 48, 48);
    view.defPosition("a8", 639, 352, 48, 48);
    view.defPosition("b8", 591, 352, 48, 48);
    view.defPosition("c8", 543, 352, 48, 48);
    view.defPosition("d8", 495, 352, 48, 48);
    view.defPosition("e8", 447, 352, 48, 48);
    view.defPosition("f8", 399, 352, 48, 48);
    view.defPosition("g8", 351, 352, 48, 48);
    view.defPosition("h8", 303, 352, 48, 48);
    view.defPosition("i8", 255, 352, 48, 48);
    view.defPosition("j8", 207, 352, 48, 48);
    view.defPosition("k8", 159, 352, 48, 48);
    view.defPosition("N8", 111, 352, 48, 48);
    view.defPosition("Z8", 63, 352, 48, 48);
    view.defPosition("T8", 15, 352, 48, 48);
