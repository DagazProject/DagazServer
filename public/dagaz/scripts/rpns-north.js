...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a4", 521, 571, 130, 113);
    view.defPosition("b4", 362, 571, 130, 113);
    view.defPosition("c4", 203, 571, 130, 113);
    view.defPosition("d4", 44, 571, 130, 113);
    view.defPosition("a2", 521, 253, 130, 113);
    view.defPosition("b2", 362, 253, 130, 113);
    view.defPosition("c2", 203, 253, 130, 113);
    view.defPosition("d2", 44, 253, 130, 113);
    view.defPosition("a3", 601, 413, 130, 113);
    view.defPosition("b3", 442, 413, 130, 113);
    view.defPosition("c3", 283, 413, 130, 113);
    view.defPosition("d3", 124, 413, 130, 113);
    view.defPosition("a1", 601, 95, 130, 113);
    view.defPosition("b1", 442, 95, 130, 113);
    view.defPosition("c1", 283, 95, 130, 113);
    view.defPosition("d1", 124, 95, 130, 113);
}
