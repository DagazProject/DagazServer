...
var createPiece = function(design, c) {
  if (c == 'P') return Dagaz.Model.createPiece(design.getPieceType("Runner"), 1);
  if (c == 'l') return Dagaz.Model.createPiece(design.getPieceType("Left"), 2);
  if (c == 'r') return Dagaz.Model.createPiece(design.getPieceType("Right"), 2);
  return null;
}
...
var getPieceNotation = function(design, piece) {
  var r = 'P';
  if (piece.type == design.getPieceType("Left"))  r = 'l';
  if (piece.type == design.getPieceType("Right")) r = 'r';
  return r;
}
