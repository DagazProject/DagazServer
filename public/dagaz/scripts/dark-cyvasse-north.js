...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.checkVersion("dark-cyvasse-view", "2");
    ...
    design.addTurn(1, [0]); // 4
    design.addTurn(1, [0]); // 5
    design.addTurn(1, [0]); // 6
    design.addTurn(1, [0]); // 7
    design.addTurn(1, [0]); // 8
    design.addTurn(1, [0]); // 9
    design.addTurn(1, [0]); // 10
    design.addTurn(1, [0]); // 11
    design.addTurn(1, [0]); // 12
    design.addTurn(1, [0]); // 13
    design.addTurn(1, [0]); // 14
    design.addTurn(1, [0]); // 15
    design.addTurn(1, [0]); // 16
    design.addTurn(1, [0]); // 17
    design.addTurn(1, [0]); // 18
    design.addTurn(1, [0]); // 19
    design.addTurn(1, [0]); // 20
    design.addTurn(1, [0]); // 21
    design.addTurn(1, [0]); // 22

    design.addTurn(2, [0]); // 23
    design.addTurn(2, [0]); // 24
    design.addTurn(2, [0]); // 25
    design.addTurn(2, [0]); // 26
    design.addTurn(2, [0]); // 27
    design.addTurn(2, [0]); // 28
    design.addTurn(2, [0]); // 29
    design.addTurn(2, [0]); // 30
    design.addTurn(2, [0]); // 31
    design.addTurn(2, [0]); // 32
    design.addTurn(2, [0]); // 33
    design.addTurn(2, [0]); // 34
    design.addTurn(2, [0]); // 35
    design.addTurn(2, [0]); // 36
    design.addTurn(2, [0]); // 37
    design.addTurn(2, [0]); // 38
    design.addTurn(2, [0]); // 39
    design.addTurn(2, [0]); // 40
    design.addTurn(2, [0]); // 41
    design.addTurn(2, [0]); // 42
    design.addTurn(2, [0]); // 43
    design.addTurn(2, [0]); // 44
    design.addTurn(2, [0]); // 45
    design.repeatMark();
    design.addTurn(1);      // 46
    design.addTurn(2);      // 47
...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("A1", 630, 409, 50, 50);
    view.defPosition("B1", 580, 409, 50, 50);
    view.defPosition("C1", 530, 409, 50, 50);
    view.defPosition("D1", 480, 409, 50, 50);
    view.defPosition("E1", 430, 409, 50, 50);
    view.defPosition("F1", 380, 409, 50, 50);
    view.defPosition("G1", 330, 409, 50, 50);
    view.defPosition("H1", 280, 409, 50, 50);
    view.defPosition("I1", 230, 409, 50, 50);
    view.defPosition("J1", 180, 409, 50, 50);
    view.defPosition("K1", 130, 409, 50, 50);
    view.defPosition("L1", 80, 409, 50, 50);
    view.defPosition("A2", 655, 359, 50, 50);
    view.defPosition("B2", 605, 359, 50, 50);
    view.defPosition("C2", 555, 359, 50, 50);
    view.defPosition("D2", 505, 359, 50, 50);
    view.defPosition("E2", 455, 359, 50, 50);
    view.defPosition("F2", 405, 359, 50, 50);
    view.defPosition("G2", 355, 359, 50, 50);
    view.defPosition("H2", 305, 359, 50, 50);
    view.defPosition("I2", 255, 359, 50, 50);
    view.defPosition("J2", 205, 359, 50, 50);
    view.defPosition("K2", 155, 359, 50, 50);
    view.defPosition("L2", 105, 359, 50, 50);
    view.defPosition("A3", 680, 309, 50, 50);
    view.defPosition("B3", 630, 309, 50, 50);
    view.defPosition("C3", 580, 309, 50, 50);
    view.defPosition("D3", 530, 309, 50, 50);
    view.defPosition("E3", 480, 309, 50, 50);
    view.defPosition("F3", 430, 309, 50, 50);
    view.defPosition("G3", 380, 309, 50, 50);
    view.defPosition("H3", 330, 309, 50, 50);
    view.defPosition("I3", 280, 309, 50, 50);
    view.defPosition("J3", 230, 309, 50, 50);
    view.defPosition("K3", 180, 309, 50, 50);
    view.defPosition("L3", 130, 309, 50, 50);
    view.defPosition("A4", 705, 259, 50, 50);
    view.defPosition("B4", 655, 259, 50, 50);
    view.defPosition("C4", 605, 259, 50, 50);
    view.defPosition("D4", 555, 259, 50, 50);
    view.defPosition("E4", 505, 259, 50, 50);
    view.defPosition("F4", 455, 259, 50, 50);
    view.defPosition("G4", 405, 259, 50, 50);
    view.defPosition("H4", 355, 259, 50, 50);
    view.defPosition("I4", 305, 259, 50, 50);
    view.defPosition("J4", 255, 259, 50, 50);
    view.defPosition("K4", 205, 259, 50, 50);
    view.defPosition("L4", 155, 259, 50, 50);
    view.defPosition("A5", 730, 209, 50, 50);
    view.defPosition("B5", 680, 209, 50, 50);
    view.defPosition("C5", 630, 209, 50, 50);
    view.defPosition("D5", 580, 209, 50, 50);
    view.defPosition("E5", 530, 209, 50, 50);
    view.defPosition("F5", 480, 209, 50, 50);
    view.defPosition("G5", 430, 209, 50, 50);
    view.defPosition("H5", 380, 209, 50, 50);
    view.defPosition("I5", 330, 209, 50, 50);
    view.defPosition("J5", 280, 209, 50, 50);
    view.defPosition("K5", 230, 209, 50, 50);
    view.defPosition("L5", 180, 209, 50, 50);
    view.defPosition("A6", 755, 159, 50, 50);
    view.defPosition("B6", 705, 159, 50, 50);
    view.defPosition("C6", 655, 159, 50, 50);
    view.defPosition("D6", 605, 159, 50, 50);
    view.defPosition("E6", 555, 159, 50, 50);
    view.defPosition("F6", 505, 159, 50, 50);
    view.defPosition("G6", 455, 159, 50, 50);
    view.defPosition("H6", 405, 159, 50, 50);
    view.defPosition("I6", 355, 159, 50, 50);
    view.defPosition("J6", 305, 159, 50, 50);
    view.defPosition("K6", 255, 159, 50, 50);
    view.defPosition("L6", 205, 159, 50, 50);
    view.defPosition("A7", 780, 109, 50, 50);
    view.defPosition("B7", 730, 109, 50, 50);
    view.defPosition("C7", 680, 109, 50, 50);
    view.defPosition("D7", 630, 109, 50, 50);
    view.defPosition("E7", 580, 109, 50, 50);
    view.defPosition("F7", 530, 109, 50, 50);
    view.defPosition("G7", 480, 109, 50, 50);
    view.defPosition("H7", 430, 109, 50, 50);
    view.defPosition("I7", 380, 109, 50, 50);
    view.defPosition("J7", 330, 109, 50, 50);
    view.defPosition("K7", 280, 109, 50, 50);
    view.defPosition("L7", 230, 109, 50, 50);
    view.defPosition("A8", 805, 59, 50, 50);
    view.defPosition("B8", 755, 59, 50, 50);
    view.defPosition("C8", 705, 59, 50, 50);
    view.defPosition("D8", 655, 59, 50, 50);
    view.defPosition("E8", 605, 59, 50, 50);
    view.defPosition("F8", 555, 59, 50, 50);
    view.defPosition("G8", 505, 59, 50, 50);
    view.defPosition("H8", 455, 59, 50, 50);
    view.defPosition("I8", 405, 59, 50, 50);
    view.defPosition("J8", 355, 59, 50, 50);
    view.defPosition("K8", 305, 59, 50, 50);
    view.defPosition("L8", 255, 59, 50, 50);
    view.defPosition("A9", 830, 9, 50, 50);
    view.defPosition("B9", 780, 9, 50, 50);
    view.defPosition("C9", 730, 9, 50, 50);
    view.defPosition("D9", 680, 9, 50, 50);
    view.defPosition("E9", 630, 9, 50, 50);
    view.defPosition("F9", 580, 9, 50, 50);
    view.defPosition("G9", 530, 9, 50, 50);
    view.defPosition("H9", 480, 9, 50, 50);
    view.defPosition("I9", 430, 9, 50, 50);
    view.defPosition("J9", 380, 9, 50, 50);
    view.defPosition("K9", 330, 9, 50, 50);
    view.defPosition("L9", 280, 9, 50, 50);
    view.defPosition("a1", 630, 409, 50, 50);
    view.defPosition("b1", 580, 409, 50, 50);
    view.defPosition("c1", 530, 409, 50, 50);
    view.defPosition("d1", 480, 409, 50, 50);
    ...
    view.defPosition("k9", 330, 9, 50, 50);
    view.defPosition("l9", 280, 9, 50, 50);
    view.defPosition("X1", 907, 409, 50, 50);
    view.defPosition("Y1", 857, 409, 50, 50);
    view.defPosition("Z1", 807, 409, 50, 50);
    view.defPosition("X2", 907, 359, 50, 50);
    view.defPosition("Y2", 857, 359, 50, 50);
    view.defPosition("Z2", 807, 359, 50, 50);
    view.defPosition("X3", 907, 309, 50, 50);
    view.defPosition("Y3", 857, 309, 50, 50);
    view.defPosition("Z3", 807, 309, 50, 50);
    view.defPosition("X4", 907, 259, 50, 50);
    view.defPosition("Y4", 857, 259, 50, 50);
    view.defPosition("Z4", 807, 259, 50, 50);
    view.defPosition("X5", 907, 209, 50, 50);
    view.defPosition("Y5", 857, 209, 50, 50);
    view.defPosition("Z5", 807, 209, 50, 50);
    view.defPosition("X6", 907, 159, 50, 50);
    view.defPosition("Y6", 857, 159, 50, 50);
    view.defPosition("Z6", 807, 159, 50, 50);
    view.defPosition("X7", 907, 109, 50, 50);
    view.defPosition("Y7", 857, 109, 50, 50);
    view.defPosition("Z7", 807, 109, 50, 50);
    view.defPosition("X8", 907, 59, 50, 50);
    view.defPosition("Y8", 857, 59, 50, 50);
    view.defPosition("Z8", 807, 59, 50, 50);
    view.defPosition("X9", 907, 9, 50, 50);
    view.defPosition("Y9", 857, 9, 50, 50);
    view.defPosition("Z9", 807, 9, 50, 50);
    view.defPosition("x1", 110, 409, 50, 50);
    view.defPosition("y1", 60, 409, 50, 50);
    view.defPosition("z1", 10, 409, 50, 50);
    view.defPosition("x2", 110, 359, 50, 50);
    view.defPosition("y2", 60, 359, 50, 50);
    view.defPosition("z2", 10, 359, 50, 50);
    view.defPosition("x3", 110, 309, 50, 50);
    view.defPosition("y3", 60, 309, 50, 50);
    view.defPosition("z3", 10, 309, 50, 50);
    view.defPosition("x4", 110, 259, 50, 50);
    view.defPosition("y4", 60, 259, 50, 50);
    view.defPosition("z4", 10, 259, 50, 50);
    view.defPosition("x5", 110, 209, 50, 50);
    view.defPosition("y5", 60, 209, 50, 50);
    view.defPosition("z5", 10, 209, 50, 50);
    view.defPosition("x6", 110, 159, 50, 50);
    view.defPosition("y6", 60, 159, 50, 50);
    view.defPosition("z6", 10, 159, 50, 50);
    view.defPosition("x7", 110, 109, 50, 50);
    view.defPosition("y7", 60, 109, 50, 50);
    view.defPosition("z7", 10, 109, 50, 50);
    view.defPosition("x8", 110, 59, 50, 50);
    view.defPosition("y8", 60, 59, 50, 50);
    view.defPosition("z8", 10, 59, 50, 50);
    view.defPosition("x9", 110, 9, 50, 50);
    view.defPosition("y9", 60, 9, 50, 50);
    view.defPosition("z9", 10, 9, 50, 50);
}
