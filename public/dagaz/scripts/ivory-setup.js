...
var createPiece = function(design, c) {
  ...
  if (c == 'N') return Dagaz.Model.createPiece(design.getPieceType("Yahoo"), 1);
  if (c == 'n') return Dagaz.Model.createPiece(design.getPieceType("Yahoo"), 2);
  if (c == 'B') return Dagaz.Model.createPiece(design.getPieceType("Fuddy-Duddy"), 1);
  if (c == 'b') return Dagaz.Model.createPiece(design.getPieceType("Fuddy-Duddy"), 2);
  ...
  if (c == 'A') return Dagaz.Model.createPiece(design.getPieceType("Toady"), 1);
  if (c == 'a') return Dagaz.Model.createPiece(design.getPieceType("Toady"), 2);
  if (c == 'C') return Dagaz.Model.createPiece(design.getPieceType("Clodhopper"), 1);
  if (c == 'c') return Dagaz.Model.createPiece(design.getPieceType("Clodhopper"), 2);
...
var getPieceNotation = function(design, piece) {
  ...
  if (piece.type == design.getPieceType("Yahoo"))       r = 'N';
  if (piece.type == design.getPieceType("Fuddy-Duddy")) r = 'B';
  if (piece.type == design.getPieceType("Numskull"))    r = 'R';
  if (piece.type == design.getPieceType("Toady"))       r = 'A';
  if (piece.type == design.getPieceType("Clodhopper"))  r = 'C';
