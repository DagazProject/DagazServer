...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.repeatMark(1);
    design.addTurn(2, [1], 1); // 1
    design.addTurn(1, [1], 1); // 2

    design.addTurn(1, [0], 2); // 0
    design.addTurn(2, [0], 2); // 1
    design.repeatMark(2);
    design.addTurn(1, [1], 2); // 2
...
//  design.addPriority(1);			// normal-type
    ...
    design.reserve("Black", "Pawn", 0, 1);
    design.reserve("Black", "Rook", 0, 1);
    design.reserve("Black", "Knight", 0, 1);
    design.reserve("Black", "Bishop", 0, 1);
    design.reserve("Black", "Queen", 0, 1);
    design.reserve("Black", "King", 0, 1);
    ...
    design.reserve("Black", "Pawn", 8, 2);
    design.reserve("Black", "Rook", 2, 2);
    design.reserve("Black", "Knight", 2, 2);
    design.reserve("Black", "Bishop", 2, 2);
    design.reserve("Black", "Queen", 1, 2);
