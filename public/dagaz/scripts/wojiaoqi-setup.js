...
var createPiece = function(design, c) {
  ...
  if (c == 'G') return Dagaz.Model.createPiece(design.getPieceType("Dun"), 1);
  if (c == 'g') return Dagaz.Model.createPiece(design.getPieceType("Dun"), 2);
...
var getPieceNotation = function(design, piece) {
  ...
  if (piece.type == design.getPieceType("Dun"))      r = 'G';
