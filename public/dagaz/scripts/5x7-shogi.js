...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addPosition("a7", [12, 11, 0, 1, 0, 0, 0, 67, 0, 72, -2]);
    design.addPosition("b7", [12, 11, 10, 1, -1, 0, 0, 67, 0, 71, -3]);
    design.addPosition("c7", [12, 11, 10, 1, -1, 0, 0, 67, 0, 70, -4]);
    design.addPosition("d7", [12, 11, 10, 1, -1, 0, 0, 67, 0, 69, -5]);
    design.addPosition("e7", [0, 11, 10, 0, -1, 0, 0, 0, 0, 68, -6]);
    ...
    design.addPosition("a6", [12, 11, 0, 1, 0, -10, 0, -11, -11, 61, -13]);
    design.addPosition("b6", [12, 11, 10, 1, -1, -10, -12, -11, -11, 60, -14]);
    design.addPosition("c6", [12, 11, 10, 1, -1, -10, -12, -11, -11, 59, -15]);
    design.addPosition("d6", [12, 11, 10, 1, -1, -10, -12, -11, -11, 58, -16]);
    design.addPosition("e6", [0, 11, 10, 0, -1, 0, -12, -11, -11, 57, -17]);
    ...
    design.addPosition("a5", [12, 11, 0, 1, 0, -10, 0, -11, -11, 50, -24]);
    design.addPosition("b5", [12, 11, 10, 1, -1, -10, -12, -11, -11, 49, -25]);
    design.addPosition("c5", [12, 11, 10, 1, -1, -10, -12, -11, -11, 48, -26]);
    design.addPosition("d5", [12, 11, 10, 1, -1, -10, -12, -11, -11, 47, -27]);
    design.addPosition("e5", [0, 11, 10, 0, -1, 0, -12, -11, -11, 46, -28]);
    ...
    design.addPosition("a3", [12, 11, 0, 1, 0, -10, 0, -11, -11, 28, -46]);
    design.addPosition("b3", [12, 11, 10, 1, -1, -10, -12, -11, -11, 27, -47]);
    design.addPosition("c3", [12, 11, 10, 1, -1, -10, -12, -11, -11, 26, -48]);
    design.addPosition("d3", [12, 11, 10, 1, -1, -10, -12, -11, -11, 25, -49]);
    design.addPosition("e3", [0, 11, 10, 0, -1, 0, -12, -11, -11, 24, -50]);
    ...
    design.addPosition("a2", [12, 11, 0, 1, 0, -10, 0, -11, -11, 17, -57]);
    design.addPosition("b2", [12, 11, 10, 1, -1, -10, -12, -11, -11, 16, -58]);
    design.addPosition("c2", [12, 11, 10, 1, -1, -10, -12, -11, -11, 15, -59]);
    design.addPosition("d2", [12, 11, 10, 1, -1, -10, -12, -11, -11, 14, -60]);
    design.addPosition("e2", [0, 11, 10, 0, -1, 0, -12, -11, -11, 13, -61]);
    ...
    design.addPosition("a1", [0, 0, 0, 1, 0, -10, 0, -11, -11, 6, -68]);
    design.addPosition("b1", [0, 0, 0, 1, -1, -10, -12, -11, -11, 5, -69]);
    design.addPosition("c1", [0, 0, 0, 1, -1, -10, -12, -11, -11, 4, -70]);
    design.addPosition("d1", [0, 0, 0, 1, -1, -10, -12, -11, -11, 3, -71]);
    design.addPosition("e1", [0, 0, 0, 0, -1, 0, -12, -11, -11, 2, -72]);
    ...
    design.addZone("promotion-zone", 2, [69, 70, 71, 72, 73, 58, 59, 60, 61, 62]);
    ...
    design.addPiece("Pawn", 12, 2);
    design.addMove(12, 0, [8], 0);
    design.addMove(12, 1, [69, 7], 0);

    design.addPiece("PawnP", 13, 4);
    ...
    design.setup("South", "King", 73);
    design.setup("South", "Gold", 72);
    design.setup("South", "Lance", 69);
    design.setup("South", "Knight", 70);
    design.setup("South", "Silver", 71);
    design.setup("South", "Bishop", 59);
    design.setup("South", "Rook", 61);
    ...
    design.setup("North", "Gold", 4);
    design.setup("North", "Lance", 7);
    design.setup("North", "Knight", 6);
    design.setup("North", "Silver", 5);
    design.setup("North", "Bishop", 17);
    design.setup("North", "Rook", 15);
    design.setup("North", "Pawn", 25);
    design.setup("North", "Pawn", 26);
    design.setup("North", "Pawn", 27);
