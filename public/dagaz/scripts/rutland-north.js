...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a10", 651, 452, 50, 50);
    view.defPosition("b10", 601, 452, 50, 50);
    view.defPosition("c10", 551, 452, 50, 50);
    view.defPosition("d10", 501, 452, 50, 50);
    view.defPosition("e10", 451, 452, 50, 50);
    view.defPosition("f10", 401, 452, 50, 50);
    view.defPosition("g10", 351, 452, 50, 50);
    view.defPosition("h10", 301, 452, 50, 50);
    view.defPosition("i10", 251, 452, 50, 50);
    view.defPosition("j10", 201, 452, 50, 50);
    view.defPosition("k10", 151, 452, 50, 50);
    view.defPosition("l10", 101, 452, 50, 50);
    view.defPosition("m10", 51, 452, 50, 50);
    view.defPosition("n10", 1, 452, 50, 50);
    view.defPosition("a9", 651, 402, 50, 50);
    view.defPosition("b9", 601, 402, 50, 50);
    view.defPosition("c9", 551, 402, 50, 50);
    view.defPosition("d9", 501, 402, 50, 50);
    view.defPosition("e9", 451, 402, 50, 50);
    view.defPosition("f9", 401, 402, 50, 50);
    view.defPosition("g9", 351, 402, 50, 50);
    view.defPosition("h9", 301, 402, 50, 50);
    view.defPosition("i9", 251, 402, 50, 50);
    view.defPosition("j9", 201, 402, 50, 50);
    view.defPosition("k9", 151, 402, 50, 50);
    view.defPosition("l9", 101, 402, 50, 50);
    view.defPosition("m9", 51, 402, 50, 50);
    view.defPosition("n9", 1, 402, 50, 50);
    view.defPosition("a8", 651, 352, 50, 50);
    view.defPosition("b8", 601, 352, 50, 50);
    view.defPosition("c8", 551, 352, 50, 50);
    view.defPosition("d8", 501, 352, 50, 50);
    view.defPosition("e8", 451, 352, 50, 50);
    view.defPosition("f8", 401, 352, 50, 50);
    view.defPosition("g8", 351, 352, 50, 50);
    view.defPosition("h8", 301, 352, 50, 50);
    view.defPosition("i8", 251, 352, 50, 50);
    view.defPosition("j8", 201, 352, 50, 50);
    view.defPosition("k8", 151, 352, 50, 50);
    view.defPosition("l8", 101, 352, 50, 50);
    view.defPosition("m8", 51, 352, 50, 50);
    view.defPosition("n8", 1, 352, 50, 50);
    view.defPosition("a7", 651, 302, 50, 50);
    view.defPosition("b7", 601, 302, 50, 50);
    view.defPosition("c7", 551, 302, 50, 50);
    view.defPosition("d7", 501, 302, 50, 50);
    view.defPosition("e7", 451, 302, 50, 50);
    view.defPosition("f7", 401, 302, 50, 50);
    view.defPosition("g7", 351, 302, 50, 50);
    view.defPosition("h7", 301, 302, 50, 50);
    view.defPosition("i7", 251, 302, 50, 50);
    view.defPosition("j7", 201, 302, 50, 50);
    view.defPosition("k7", 151, 302, 50, 50);
    view.defPosition("l7", 101, 302, 50, 50);
    view.defPosition("m7", 51, 302, 50, 50);
    view.defPosition("n7", 1, 302, 50, 50);
    view.defPosition("a6", 651, 252, 50, 50);
    view.defPosition("b6", 601, 252, 50, 50);
    view.defPosition("c6", 551, 252, 50, 50);
    view.defPosition("d6", 501, 252, 50, 50);
    view.defPosition("e6", 451, 252, 50, 50);
    view.defPosition("f6", 401, 252, 50, 50);
    view.defPosition("g6", 351, 252, 50, 50);
    view.defPosition("h6", 301, 252, 50, 50);
    view.defPosition("i6", 251, 252, 50, 50);
    view.defPosition("j6", 201, 252, 50, 50);
    view.defPosition("k6", 151, 252, 50, 50);
    view.defPosition("l6", 101, 252, 50, 50);
    view.defPosition("m6", 51, 252, 50, 50);
    view.defPosition("n6", 1, 252, 50, 50);
    view.defPosition("a5", 651, 202, 50, 50);
    view.defPosition("b5", 601, 202, 50, 50);
    view.defPosition("c5", 551, 202, 50, 50);
    view.defPosition("d5", 501, 202, 50, 50);
    view.defPosition("e5", 451, 202, 50, 50);
    view.defPosition("f5", 401, 202, 50, 50);
    view.defPosition("g5", 351, 202, 50, 50);
    view.defPosition("h5", 301, 202, 50, 50);
    view.defPosition("i5", 251, 202, 50, 50);
    view.defPosition("j5", 201, 202, 50, 50);
    view.defPosition("k5", 151, 202, 50, 50);
    view.defPosition("l5", 101, 202, 50, 50);
    view.defPosition("m5", 51, 202, 50, 50);
    view.defPosition("n5", 1, 202, 50, 50);
    view.defPosition("a4", 651, 152, 50, 50);
    view.defPosition("b4", 601, 152, 50, 50);
    view.defPosition("c4", 551, 152, 50, 50);
    view.defPosition("d4", 501, 152, 50, 50);
    view.defPosition("e4", 451, 152, 50, 50);
    view.defPosition("f4", 401, 152, 50, 50);
    view.defPosition("g4", 351, 152, 50, 50);
    view.defPosition("h4", 301, 152, 50, 50);
    view.defPosition("i4", 251, 152, 50, 50);
    view.defPosition("j4", 201, 152, 50, 50);
    view.defPosition("k4", 151, 152, 50, 50);
    view.defPosition("l4", 101, 152, 50, 50);
    view.defPosition("m4", 51, 152, 50, 50);
    view.defPosition("n4", 1, 152, 50, 50);
    view.defPosition("a3", 651, 102, 50, 50);
    view.defPosition("b3", 601, 102, 50, 50);
    view.defPosition("c3", 551, 102, 50, 50);
    view.defPosition("d3", 501, 102, 50, 50);
    view.defPosition("e3", 451, 102, 50, 50);
    view.defPosition("f3", 401, 102, 50, 50);
    view.defPosition("g3", 351, 102, 50, 50);
    view.defPosition("h3", 301, 102, 50, 50);
    view.defPosition("i3", 251, 102, 50, 50);
    view.defPosition("j3", 201, 102, 50, 50);
    view.defPosition("k3", 151, 102, 50, 50);
    view.defPosition("l3", 101, 102, 50, 50);
    view.defPosition("m3", 51, 102, 50, 50);
    view.defPosition("n3", 1, 102, 50, 50);
    view.defPosition("a2", 651, 52, 50, 50);
    view.defPosition("b2", 601, 52, 50, 50);
    view.defPosition("c2", 551, 52, 50, 50);
    view.defPosition("d2", 501, 52, 50, 50);
    view.defPosition("e2", 451, 52, 50, 50);
    view.defPosition("f2", 401, 52, 50, 50);
    view.defPosition("g2", 351, 52, 50, 50);
    view.defPosition("h2", 301, 52, 50, 50);
    view.defPosition("i2", 251, 52, 50, 50);
    view.defPosition("j2", 201, 52, 50, 50);
    view.defPosition("k2", 151, 52, 50, 50);
    view.defPosition("l2", 101, 52, 50, 50);
    view.defPosition("m2", 51, 52, 50, 50);
    view.defPosition("n2", 1, 52, 50, 50);
    view.defPosition("a1", 651, 2, 50, 50);
    view.defPosition("b1", 601, 2, 50, 50);
    view.defPosition("c1", 551, 2, 50, 50);
    view.defPosition("d1", 501, 2, 50, 50);
    view.defPosition("e1", 451, 2, 50, 50);
    view.defPosition("f1", 401, 2, 50, 50);
    view.defPosition("g1", 351, 2, 50, 50);
    view.defPosition("h1", 301, 2, 50, 50);
    view.defPosition("i1", 251, 2, 50, 50);
    view.defPosition("j1", 201, 2, 50, 50);
    view.defPosition("k1", 151, 2, 50, 50);
    view.defPosition("l1", 101, 2, 50, 50);
    view.defPosition("m1", 51, 2, 50, 50);
    view.defPosition("n1", 1, 2, 50, 50);
