...
var createPiece = function(design, c) {
  ...
  if (c == 'L') return Dagaz.Model.createPiece(design.getPieceType("Leopard"), 1);
  if (c == 'l') return Dagaz.Model.createPiece(design.getPieceType("Leopard"), 2);
...
var getPieceNotation = function(design, piece) {
  ...
  if (piece.type == design.getPieceType("Leopard"))  r = 'L';
