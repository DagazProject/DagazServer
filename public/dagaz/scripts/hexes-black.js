...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("d20", 143, 556, 54, 50);
    view.defPosition("e19", 97, 529, 56, 50);
    view.defPosition("f18", 52, 502, 56, 50);
    view.defPosition("c19", 188, 529, 54, 50);
    view.defPosition("d18", 143, 502, 54, 50);
    view.defPosition("e17", 97, 475, 56, 50);
    view.defPosition("f16", 52, 448, 56, 50);
    view.defPosition("b18", 232, 502, 56, 50);
    view.defPosition("c17", 188, 475, 54, 50);
    view.defPosition("d16", 143, 448, 54, 50);
    view.defPosition("e15", 97, 421, 56, 50);
    view.defPosition("f14", 52, 394, 56, 50);
    view.defPosition("a17", 277, 475, 56, 50);
    view.defPosition("b16", 232, 448, 56, 50);
    view.defPosition("c15", 188, 421, 54, 50);
    view.defPosition("d14", 143, 394, 54, 50);
    view.defPosition("e13", 97, 367, 56, 50);
    view.defPosition("f12", 52, 340, 56, 50);
    view.defPosition("a15", 277, 421, 56, 50);
    view.defPosition("b14", 232, 394, 56, 50);
    view.defPosition("c13", 188, 367, 54, 50);
    view.defPosition("d12", 143, 340, 54, 50);
    view.defPosition("e11", 97, 313, 56, 50);
    view.defPosition("f10", 52, 286, 56, 50);
    view.defPosition("a13", 277, 367, 56, 50);
    view.defPosition("b12", 232, 340, 56, 50);
    view.defPosition("c11", 188, 313, 54, 50);
    view.defPosition("d10", 143, 286, 54, 50);
    view.defPosition("e9", 97, 259, 56, 50);
    view.defPosition("f8", 52, 232, 56, 50);
    view.defPosition("a11", 277, 313, 56, 50);
    view.defPosition("b10", 232, 286, 56, 50);
    view.defPosition("c9", 188, 259, 54, 50);
    view.defPosition("d8", 143, 232, 54, 50);
    view.defPosition("e7", 97, 205, 56, 50);
    view.defPosition("f6", 52, 178, 56, 50);
    view.defPosition("a9", 277, 259, 56, 50);
    view.defPosition("b8", 232, 232, 56, 50);
    view.defPosition("c7", 188, 205, 54, 50);
    view.defPosition("d6", 143, 178, 54, 50);
    view.defPosition("e5", 97, 151, 56, 50);
    view.defPosition("f4", 52, 124, 56, 50);
    view.defPosition("a7", 277, 205, 56, 50);
    view.defPosition("b6", 232, 178, 56, 50);
    view.defPosition("c5", 188, 151, 54, 50);
    view.defPosition("d4", 143, 124, 54, 50);
    view.defPosition("e3", 97, 97, 56, 50);
    view.defPosition("a5", 277, 151, 56, 50);
    view.defPosition("b4", 232, 124, 56, 50);
    view.defPosition("c3", 188, 97, 54, 50);
    view.defPosition("d2", 143, 70, 54, 50);
    view.defPosition("a3", 277, 97, 56, 50);
    view.defPosition("b2", 232, 70, 56, 50);
    view.defPosition("c1", 188, 43, 54, 50);
