...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a8", 348, 348, 49, 49);
    view.defPosition("b8", 299, 348, 49, 49);
    view.defPosition("c8", 250, 348, 49, 49);
    view.defPosition("d8", 201, 348, 49, 49);
    view.defPosition("e8", 152, 348, 49, 49);
    view.defPosition("f8", 103, 348, 49, 49);
    view.defPosition("g8", 54, 348, 49, 49);
    view.defPosition("h8", 5, 348, 49, 49);
    view.defPosition("a7", 348, 299, 49, 49);
    view.defPosition("b7", 299, 299, 49, 49);
    view.defPosition("c7", 250, 299, 49, 49);
    view.defPosition("d7", 201, 299, 49, 49);
    view.defPosition("e7", 152, 299, 49, 49);
    view.defPosition("f7", 103, 299, 49, 49);
    view.defPosition("g7", 54, 299, 49, 49);
    view.defPosition("h7", 5, 299, 49, 49);
    view.defPosition("a6", 348, 250, 49, 49);
    view.defPosition("b6", 299, 250, 49, 49);
    view.defPosition("c6", 250, 250, 49, 49);
    view.defPosition("d6", 201, 250, 49, 49);
    view.defPosition("e6", 152, 250, 49, 49);
    view.defPosition("f6", 103, 250, 49, 49);
    view.defPosition("g6", 54, 250, 49, 49);
    view.defPosition("h6", 5, 250, 49, 49);
    view.defPosition("a5", 348, 201, 49, 49);
    view.defPosition("b5", 299, 201, 49, 49);
    view.defPosition("c5", 250, 201, 49, 49);
    view.defPosition("d5", 201, 201, 49, 49);
    view.defPosition("e5", 152, 201, 49, 49);
    view.defPosition("f5", 103, 201, 49, 49);
    view.defPosition("g5", 54, 201, 49, 49);
    view.defPosition("h5", 5, 201, 49, 49);
    view.defPosition("a4", 348, 152, 49, 49);
    view.defPosition("b4", 299, 152, 49, 49);
    view.defPosition("c4", 250, 152, 49, 49);
    view.defPosition("d4", 201, 152, 49, 49);
    view.defPosition("e4", 152, 152, 49, 49);
    view.defPosition("f4", 103, 152, 49, 49);
    view.defPosition("g4", 54, 152, 49, 49);
    view.defPosition("h4", 5, 152, 49, 49);
    view.defPosition("a3", 348, 103, 49, 49);
    view.defPosition("b3", 299, 103, 49, 49);
    view.defPosition("c3", 250, 103, 49, 49);
    view.defPosition("d3", 201, 103, 49, 49);
    view.defPosition("e3", 152, 103, 49, 49);
    view.defPosition("f3", 103, 103, 49, 49);
    view.defPosition("g3", 54, 103, 49, 49);
    view.defPosition("h3", 5, 103, 49, 49);
    view.defPosition("a2", 348, 54, 49, 49);
    view.defPosition("b2", 299, 54, 49, 49);
    view.defPosition("c2", 250, 54, 49, 49);
    view.defPosition("d2", 201, 54, 49, 49);
    view.defPosition("e2", 152, 54, 49, 49);
    view.defPosition("f2", 103, 54, 49, 49);
    view.defPosition("g2", 54, 54, 49, 49);
    view.defPosition("h2", 5, 54, 49, 49);
    view.defPosition("a1", 348, 5, 49, 49);
    view.defPosition("b1", 299, 5, 49, 49);
    view.defPosition("c1", 250, 5, 49, 49);
    view.defPosition("d1", 201, 5, 49, 49);
    view.defPosition("e1", 152, 5, 49, 49);
    view.defPosition("f1", 103, 5, 49, 49);
    view.defPosition("g1", 54, 5, 49, 49);
    view.defPosition("h1", 5, 5, 49, 49);
}
