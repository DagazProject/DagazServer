...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a9", 337, 378, 41, 46);
    view.defPosition("b9", 296, 378, 41, 46);
    view.defPosition("c9", 255, 378, 41, 46);
    view.defPosition("d9", 214, 378, 41, 46);
    view.defPosition("e9", 173, 378, 41, 46);
    view.defPosition("f9", 132, 378, 41, 46);
    view.defPosition("g9", 91, 378, 41, 46);
    view.defPosition("h9", 50, 378, 41, 46);
    view.defPosition("i9", 9, 378, 41, 46);
    view.defPosition("a8", 337, 332, 41, 46);
    view.defPosition("b8", 296, 332, 41, 46);
    view.defPosition("c8", 255, 332, 41, 46);
    view.defPosition("d8", 214, 332, 41, 46);
    view.defPosition("e8", 173, 332, 41, 46);
    view.defPosition("f8", 132, 332, 41, 46);
    view.defPosition("g8", 91, 332, 41, 46);
    view.defPosition("h8", 50, 332, 41, 46);
    view.defPosition("i8", 9, 332, 41, 46);
    view.defPosition("a7", 337, 286, 41, 46);
    view.defPosition("b7", 296, 286, 41, 46);
    view.defPosition("c7", 255, 286, 41, 46);
    view.defPosition("d7", 214, 286, 41, 46);
    view.defPosition("e7", 173, 286, 41, 46);
    view.defPosition("f7", 132, 286, 41, 46);
    view.defPosition("g7", 91, 286, 41, 46);
    view.defPosition("h7", 50, 286, 41, 46);
    view.defPosition("i7", 9, 286, 41, 46);
    view.defPosition("a6", 337, 240, 41, 46);
    view.defPosition("b6", 296, 240, 41, 46);
    view.defPosition("c6", 255, 240, 41, 46);
    view.defPosition("d6", 214, 240, 41, 46);
    view.defPosition("e6", 173, 240, 41, 46);
    view.defPosition("f6", 132, 240, 41, 46);
    view.defPosition("g6", 91, 240, 41, 46);
    view.defPosition("h6", 50, 240, 41, 46);
    view.defPosition("i6", 9, 240, 41, 46);
    view.defPosition("a5", 337, 194, 41, 46);
    view.defPosition("b5", 296, 194, 41, 46);
    view.defPosition("c5", 255, 194, 41, 46);
    view.defPosition("d5", 214, 194, 41, 46);
    view.defPosition("e5", 173, 194, 41, 46);
    view.defPosition("f5", 132, 194, 41, 46);
    view.defPosition("g5", 91, 194, 41, 46);
    view.defPosition("h5", 50, 194, 41, 46);
    view.defPosition("i5", 9, 194, 41, 46);
    view.defPosition("a4", 337, 148, 41, 46);
    view.defPosition("b4", 296, 148, 41, 46);
    view.defPosition("c4", 255, 148, 41, 46);
    view.defPosition("d4", 214, 148, 41, 46);
    view.defPosition("e4", 173, 148, 41, 46);
    view.defPosition("f4", 132, 148, 41, 46);
    view.defPosition("g4", 91, 148, 41, 46);
    view.defPosition("h4", 50, 148, 41, 46);
    view.defPosition("i4", 9, 148, 41, 46);
    view.defPosition("a3", 337, 102, 41, 46);
    view.defPosition("b3", 296, 102, 41, 46);
    view.defPosition("c3", 255, 102, 41, 46);
    view.defPosition("d3", 214, 102, 41, 46);
    view.defPosition("e3", 173, 102, 41, 46);
    view.defPosition("f3", 132, 102, 41, 46);
    view.defPosition("g3", 91, 102, 41, 46);
    view.defPosition("h3", 50, 102, 41, 46);
    view.defPosition("i3", 9, 102, 41, 46);
    view.defPosition("a2", 337, 56, 41, 46);
    view.defPosition("b2", 296, 56, 41, 46);
    view.defPosition("c2", 255, 56, 41, 46);
    view.defPosition("d2", 214, 56, 41, 46);
    view.defPosition("e2", 173, 56, 41, 46);
    view.defPosition("f2", 132, 56, 41, 46);
    view.defPosition("g2", 91, 56, 41, 46);
    view.defPosition("h2", 50, 56, 41, 46);
    view.defPosition("i2", 9, 56, 41, 46);
    view.defPosition("a1", 337, 10, 41, 46);
    view.defPosition("b1", 296, 10, 41, 46);
    view.defPosition("c1", 255, 10, 41, 46);
    view.defPosition("d1", 214, 10, 41, 46);
    view.defPosition("e1", 173, 10, 41, 46);
    view.defPosition("f1", 132, 10, 41, 46);
    view.defPosition("g1", 91, 10, 41, 46);
    view.defPosition("h1", 50, 10, 41, 46);
    view.defPosition("i1", 9, 10, 41, 46);
