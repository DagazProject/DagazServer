...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a8", 362, 422, 59, 59);
    view.defPosition("b8", 302, 422, 59, 59);
    view.defPosition("c8", 242, 422, 59, 59);
    view.defPosition("d8", 182, 422, 59, 59);
    view.defPosition("e8", 122, 422, 59, 59);
    view.defPosition("f8", 62, 422, 59, 59);
    view.defPosition("g8", 2, 422, 59, 59);
    view.defPosition("a7", 362, 362, 59, 59);
    view.defPosition("b7", 302, 362, 59, 59);
    view.defPosition("c7", 242, 362, 59, 59);
    view.defPosition("d7", 182, 362, 59, 59);
    view.defPosition("e7", 122, 362, 59, 59);
    view.defPosition("f7", 62, 362, 59, 59);
    view.defPosition("g7", 2, 362, 59, 59);
    view.defPosition("a6", 362, 302, 59, 59);
    view.defPosition("b6", 302, 302, 59, 59);
    view.defPosition("c6", 242, 302, 59, 59);
    view.defPosition("d6", 182, 302, 59, 59);
    view.defPosition("e6", 122, 302, 59, 59);
    view.defPosition("f6", 62, 302, 59, 59);
    view.defPosition("g6", 2, 302, 59, 59);
    view.defPosition("a5", 362, 242, 59, 59);
    view.defPosition("b5", 302, 242, 59, 59);
    view.defPosition("c5", 242, 242, 59, 59);
    view.defPosition("d5", 182, 242, 59, 59);
    view.defPosition("e5", 122, 242, 59, 59);
    view.defPosition("f5", 62, 242, 59, 59);
    view.defPosition("g5", 2, 242, 59, 59);
    view.defPosition("a4", 362, 182, 59, 59);
    view.defPosition("b4", 302, 182, 59, 59);
    view.defPosition("c4", 242, 182, 59, 59);
    view.defPosition("d4", 182, 182, 59, 59);
    view.defPosition("e4", 122, 182, 59, 59);
    view.defPosition("f4", 62, 182, 59, 59);
    view.defPosition("g4", 2, 182, 59, 59);
    view.defPosition("a3", 362, 122, 59, 59);
    view.defPosition("b3", 302, 122, 59, 59);
    view.defPosition("c3", 242, 122, 59, 59);
    view.defPosition("d3", 182, 122, 59, 59);
    view.defPosition("e3", 122, 122, 59, 59);
    view.defPosition("f3", 62, 122, 59, 59);
    view.defPosition("g3", 2, 122, 59, 59);
    view.defPosition("a2", 362, 62, 59, 59);
    view.defPosition("b2", 302, 62, 59, 59);
    view.defPosition("c2", 242, 62, 59, 59);
    view.defPosition("d2", 182, 62, 59, 59);
    view.defPosition("e2", 122, 62, 59, 59);
    view.defPosition("f2", 62, 62, 59, 59);
    view.defPosition("g2", 2, 62, 59, 59);
    view.defPosition("a1", 362, 2, 59, 59);
    view.defPosition("b1", 302, 2, 59, 59);
    view.defPosition("c1", 242, 2, 59, 59);
    view.defPosition("d1", 182, 2, 59, 59);
    view.defPosition("e1", 122, 2, 59, 59);
    view.defPosition("f1", 62, 2, 59, 59);
    view.defPosition("g1", 2, 2, 59, 59);
}
