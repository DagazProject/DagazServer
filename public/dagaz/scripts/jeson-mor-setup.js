...
var createPiece = function(design, c) {
  ...
  if (c == 'K') return Dagaz.Model.createPiece(design.getPieceType("RoyalKnight"), 1);
  if (c == 'k') return Dagaz.Model.createPiece(design.getPieceType("RoyalKnight"), 2);
  return null;
}
...
var getPieceNotation = function(design, piece) {
  ...
  if (piece.type == design.getPieceType("RoyalKnight"))    r = 'K';
  if (piece.player > 1) {
