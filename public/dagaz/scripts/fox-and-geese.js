...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("Fox", "Defender", 24, 1);
    design.setup("Goose", "Soldier", 28, 1);
    design.setup("Goose", "Soldier", 29, 1);
    design.setup("Goose", "Soldier", 44, 1);
    design.setup("Goose", "Soldier", 37, 1);
    design.setup("Goose", "Soldier", 30, 1);
    design.setup("Goose", "Soldier", 45, 1);
    design.setup("Goose", "Soldier", 38, 1);
    design.setup("Goose", "Soldier", 31, 1);
    design.setup("Goose", "Soldier", 46, 1);
    design.setup("Goose", "Soldier", 39, 1);
    design.setup("Goose", "Soldier", 32, 1);
    design.setup("Goose", "Soldier", 33, 1);
    design.setup("Goose", "Soldier", 34, 1);

    design.setup("Fox", "Defender", 24, 2);
    design.setup("Goose", "Soldier", 28, 2);
    design.setup("Goose", "Soldier", 29, 2);
    design.setup("Goose", "Soldier", 44, 2);
    design.setup("Goose", "Soldier", 37, 2);
    design.setup("Goose", "Soldier", 30, 2);
    design.setup("Goose", "Soldier", 45, 2);
    design.setup("Goose", "Soldier", 38, 2);
    design.setup("Goose", "Soldier", 31, 2);
    design.setup("Goose", "Soldier", 46, 2);
    design.setup("Goose", "Soldier", 39, 2);
    design.setup("Goose", "Soldier", 32, 2);
    design.setup("Goose", "Soldier", 33, 2);
    design.setup("Goose", "Soldier", 34, 2);
    design.setup("Goose", "Soldier", 21, 2);
    design.setup("Goose", "Soldier", 27, 2);

    design.setup("Fox", "Defender", 24, 3);
    design.setup("Goose", "Soldier", 28, 3);
    design.setup("Goose", "Soldier", 29, 3);
    design.setup("Goose", "Soldier", 44, 3);
    design.setup("Goose", "Soldier", 37, 3);
    design.setup("Goose", "Soldier", 30, 3);
    design.setup("Goose", "Soldier", 45, 3);
    design.setup("Goose", "Soldier", 38, 3);
    design.setup("Goose", "Soldier", 31, 3);
    design.setup("Goose", "Soldier", 46, 3);
    design.setup("Goose", "Soldier", 39, 3);
    design.setup("Goose", "Soldier", 32, 3);
    design.setup("Goose", "Soldier", 33, 3);
    design.setup("Goose", "Soldier", 34, 3);
    design.setup("Goose", "Soldier", 21, 3);
    design.setup("Goose", "Soldier", 27, 3);
    design.setup("Goose", "Soldier", 22, 3);
    design.setup("Goose", "Soldier", 26, 3);

    design.setup("Fox", "Defender", 24, 4);
    design.setup("Goose", "Soldier", 28, 4);
    design.setup("Goose", "Soldier", 29, 4);
    design.setup("Goose", "Soldier", 44, 4);
    design.setup("Goose", "Soldier", 37, 4);
    design.setup("Goose", "Soldier", 30, 4);
    design.setup("Goose", "Soldier", 45, 4);
    design.setup("Goose", "Soldier", 38, 4);
    design.setup("Goose", "Soldier", 31, 4);
    design.setup("Goose", "Soldier", 46, 4);
    design.setup("Goose", "Soldier", 39, 4);
    design.setup("Goose", "Soldier", 32, 4);
    design.setup("Goose", "Soldier", 33, 4);
    design.setup("Goose", "Soldier", 34, 4);
    design.setup("Goose", "Soldier", 21, 4);
    design.setup("Goose", "Soldier", 27, 4);
    design.setup("Goose", "Soldier", 14, 4);
    design.setup("Goose", "Soldier", 20, 4);
}
