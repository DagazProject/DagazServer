...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a8", 272, 273, 38, 38);
    view.defPosition("b8", 234, 273, 38, 38);
    view.defPosition("c8", 196, 273, 38, 38);
    view.defPosition("d8", 158, 273, 38, 38);
    view.defPosition("e8", 120, 273, 38, 38);
    view.defPosition("f8", 82, 273, 38, 38);
    view.defPosition("g8", 44, 273, 38, 38);
    view.defPosition("h8", 6, 273, 38, 38);
    view.defPosition("a7", 272, 235, 38, 38);
    view.defPosition("b7", 234, 235, 38, 38);
    view.defPosition("c7", 196, 235, 38, 38);
    view.defPosition("d7", 158, 235, 38, 38);
    view.defPosition("e7", 120, 235, 38, 38);
    view.defPosition("f7", 82, 235, 38, 38);
    view.defPosition("g7", 44, 235, 38, 38);
    view.defPosition("h7", 6, 235, 38, 38);
    view.defPosition("a6", 272, 197, 38, 38);
    view.defPosition("b6", 234, 197, 38, 38);
    view.defPosition("c6", 196, 197, 38, 38);
    view.defPosition("d6", 158, 197, 38, 38);
    view.defPosition("e6", 120, 197, 38, 38);
    view.defPosition("f6", 82, 197, 38, 38);
    view.defPosition("g6", 44, 197, 38, 38);
    view.defPosition("h6", 6, 197, 38, 38);
    view.defPosition("a5", 272, 159, 38, 38);
    view.defPosition("b5", 234, 159, 38, 38);
    view.defPosition("c5", 196, 159, 38, 38);
    view.defPosition("d5", 158, 159, 38, 38);
    view.defPosition("e5", 120, 159, 38, 38);
    view.defPosition("f5", 82, 159, 38, 38);
    view.defPosition("g5", 44, 159, 38, 38);
    view.defPosition("h5", 6, 159, 38, 38);
    view.defPosition("a4", 272, 121, 38, 38);
    view.defPosition("b4", 234, 121, 38, 38);
    view.defPosition("c4", 196, 121, 38, 38);
    view.defPosition("d4", 158, 121, 38, 38);
    view.defPosition("e4", 120, 121, 38, 38);
    view.defPosition("f4", 82, 121, 38, 38);
    view.defPosition("g4", 44, 121, 38, 38);
    view.defPosition("h4", 6, 121, 38, 38);
    view.defPosition("a3", 272, 83, 38, 38);
    view.defPosition("b3", 234, 83, 38, 38);
    view.defPosition("c3", 196, 83, 38, 38);
    view.defPosition("d3", 158, 83, 38, 38);
    view.defPosition("e3", 120, 83, 38, 38);
    view.defPosition("f3", 82, 83, 38, 38);
    view.defPosition("g3", 44, 83, 38, 38);
    view.defPosition("h3", 6, 83, 38, 38);
    view.defPosition("a2", 272, 45, 38, 38);
    view.defPosition("b2", 234, 45, 38, 38);
    view.defPosition("c2", 196, 45, 38, 38);
    view.defPosition("d2", 158, 45, 38, 38);
    view.defPosition("e2", 120, 45, 38, 38);
    view.defPosition("f2", 82, 45, 38, 38);
    view.defPosition("g2", 44, 45, 38, 38);
    view.defPosition("h2", 6, 45, 38, 38);
    view.defPosition("a1", 272, 7, 38, 38);
    view.defPosition("b1", 234, 7, 38, 38);
    view.defPosition("c1", 196, 7, 38, 38);
    view.defPosition("d1", 158, 7, 38, 38);
    view.defPosition("e1", 120, 7, 38, 38);
    view.defPosition("f1", 82, 7, 38, 38);
    view.defPosition("g1", 44, 7, 38, 38);
    view.defPosition("h1", 6, 7, 38, 38);
