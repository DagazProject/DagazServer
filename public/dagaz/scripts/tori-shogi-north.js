...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("X7", 591, 305, 48, 48);
    view.defPosition("Y7", 543, 305, 48, 48);
    view.defPosition("M7", 495, 305, 48, 48);
    view.defPosition("a7", 447, 305, 48, 48);
    view.defPosition("b7", 399, 305, 48, 48);
    view.defPosition("c7", 351, 305, 48, 48);
    view.defPosition("d7", 303, 305, 48, 48);
    view.defPosition("e7", 255, 305, 48, 48);
    view.defPosition("f7", 207, 305, 48, 48);
    view.defPosition("g7", 159, 305, 48, 48);
    view.defPosition("N7", 111, 305, 48, 48);
    view.defPosition("Z7", 63, 305, 48, 48);
    view.defPosition("T7", 15, 305, 48, 48);
    view.defPosition("X6", 591, 257, 48, 48);
    view.defPosition("Y6", 543, 257, 48, 48);
    view.defPosition("M6", 495, 257, 48, 48);
    view.defPosition("a6", 447, 257, 48, 48);
    view.defPosition("b6", 399, 257, 48, 48);
    view.defPosition("c6", 351, 257, 48, 48);
    view.defPosition("d6", 303, 257, 48, 48);
    view.defPosition("e6", 255, 257, 48, 48);
    view.defPosition("f6", 207, 257, 48, 48);
    view.defPosition("g6", 159, 257, 48, 48);
    view.defPosition("N6", 111, 257, 48, 48);
    view.defPosition("Z6", 63, 257, 48, 48);
    view.defPosition("T6", 15, 257, 48, 48);
    view.defPosition("X5", 591, 209, 48, 48);
    view.defPosition("Y5", 543, 209, 48, 48);
    view.defPosition("M5", 495, 209, 48, 48);
    view.defPosition("a5", 447, 209, 48, 48);
    view.defPosition("b5", 399, 209, 48, 48);
    view.defPosition("c5", 351, 209, 48, 48);
    view.defPosition("d5", 303, 209, 48, 48);
    view.defPosition("e5", 255, 209, 48, 48);
    view.defPosition("f5", 207, 209, 48, 48);
    view.defPosition("g5", 159, 209, 48, 48);
    view.defPosition("N5", 111, 209, 48, 48);
    view.defPosition("Z5", 63, 209, 48, 48);
    view.defPosition("T5", 15, 209, 48, 48);
    view.defPosition("X4", 591, 161, 48, 48);
    view.defPosition("Y4", 543, 161, 48, 48);
    view.defPosition("M4", 495, 161, 48, 48);
    view.defPosition("a4", 447, 161, 48, 48);
    view.defPosition("b4", 399, 161, 48, 48);
    view.defPosition("c4", 351, 161, 48, 48);
    view.defPosition("d4", 303, 161, 48, 48);
    view.defPosition("e4", 255, 161, 48, 48);
    view.defPosition("f4", 207, 161, 48, 48);
    view.defPosition("g4", 159, 161, 48, 48);
    view.defPosition("N4", 111, 161, 48, 48);
    view.defPosition("Z4", 63, 161, 48, 48);
    view.defPosition("T4", 15, 161, 48, 48);
    view.defPosition("X3", 591, 113, 48, 48);
    view.defPosition("Y3", 543, 113, 48, 48);
    view.defPosition("M3", 495, 113, 48, 48);
    view.defPosition("a3", 447, 113, 48, 48);
    view.defPosition("b3", 399, 113, 48, 48);
    view.defPosition("c3", 351, 113, 48, 48);
    view.defPosition("d3", 303, 113, 48, 48);
    view.defPosition("e3", 255, 113, 48, 48);
    view.defPosition("f3", 207, 113, 48, 48);
    view.defPosition("g3", 159, 113, 48, 48);
    view.defPosition("N3", 111, 113, 48, 48);
    view.defPosition("Z3", 63, 113, 48, 48);
    view.defPosition("T3", 15, 113, 48, 48);
    view.defPosition("X2", 591, 65, 48, 48);
    view.defPosition("Y2", 543, 65, 48, 48);
    view.defPosition("M2", 495, 65, 48, 48);
    view.defPosition("a2", 447, 65, 48, 48);
    view.defPosition("b2", 399, 65, 48, 48);
    view.defPosition("c2", 351, 65, 48, 48);
    view.defPosition("d2", 303, 65, 48, 48);
    view.defPosition("e2", 255, 65, 48, 48);
    view.defPosition("f2", 207, 65, 48, 48);
    view.defPosition("g2", 159, 65, 48, 48);
    view.defPosition("N2", 111, 65, 48, 48);
    view.defPosition("Z2", 63, 65, 48, 48);
    view.defPosition("T2", 15, 65, 48, 48);
    view.defPosition("X1", 591, 17, 48, 48);
    view.defPosition("Y1", 543, 17, 48, 48);
    view.defPosition("M1", 495, 17, 48, 48);
    view.defPosition("a1", 447, 17, 48, 48);
    view.defPosition("b1", 399, 17, 48, 48);
    view.defPosition("c1", 351, 17, 48, 48);
    view.defPosition("d1", 303, 17, 48, 48);
    view.defPosition("e1", 255, 17, 48, 48);
    view.defPosition("f1", 207, 17, 48, 48);
    view.defPosition("g1", 159, 17, 48, 48);
