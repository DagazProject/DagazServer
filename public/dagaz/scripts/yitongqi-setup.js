...
var createPiece = function(design, c) {
  ...
  if (c == 'M') return Dagaz.Model.createPiece(design.getPieceType("Manchu"), 1);
  if (c == 'm') return Dagaz.Model.createPiece(design.getPieceType("Manchu"), 2);
...
var getPieceNotation = function(design, piece) {
  ...
  if (piece.type == design.getPieceType("Manchu"))   r = 'M';
