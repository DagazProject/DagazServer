...
var createPiece = function(design, c) {
  ...
  if (c == 'B') return Dagaz.Model.createPiece(design.getPieceType("Prince"), 1);
  if (c == 'b') return Dagaz.Model.createPiece(design.getPieceType("Prince"), 2);
  return null;
}
...
var getPieceNotation = function(design, piece) {
  ...
  if (piece.type == design.getPieceType("Prince")) r = 'B';
  if (piece.player > 1) {
