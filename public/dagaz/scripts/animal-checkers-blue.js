...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("N4", 334, 201, 66, 66);
    view.defPosition("a4", 268, 201, 66, 66);
    view.defPosition("b4", 202, 201, 66, 66);
    view.defPosition("c4", 136, 201, 66, 66);
    view.defPosition("d4", 70, 201, 66, 66);
    view.defPosition("M4", 4, 201, 66, 66);
    view.defPosition("N3", 334, 135, 66, 66);
    view.defPosition("a3", 268, 135, 66, 66);
    view.defPosition("b3", 202, 135, 66, 66);
    view.defPosition("c3", 136, 135, 66, 66);
    view.defPosition("d3", 70, 135, 66, 66);
    view.defPosition("M3", 4, 135, 66, 66);
    view.defPosition("N2", 334, 69, 66, 66);
    view.defPosition("a2", 268, 69, 66, 66);
    view.defPosition("b2", 202, 69, 66, 66);
    view.defPosition("c2", 136, 69, 66, 66);
    view.defPosition("d2", 70, 69, 66, 66);
    view.defPosition("M2", 4, 69, 66, 66);
    view.defPosition("N1", 334, 3, 66, 66);
    view.defPosition("a1", 268, 3, 66, 66);
    view.defPosition("b1", 202, 3, 66, 66);
    view.defPosition("c1", 136, 3, 66, 66);
    view.defPosition("d1", 70, 3, 66, 66);
    view.defPosition("M1", 4, 3, 66, 66);
